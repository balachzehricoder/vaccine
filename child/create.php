...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $CHILDREN_DATEOFBIRTH = $_POST["CHILDREN_DATEOFBIRTH"];
    

    do {
        if (empty($CHILDREN_NAME) || empty($CHILDREN_DATEOFBIRTH || empty($PARENTID))){
            $erroMessage = "ALL the fields are required";
            break;
        }

        //add new employee to database
        $sql = "INSERT INTO children (CHILDREN_NAME, CHILDREN_DATEOFBIRTH) VALUES ('$CHILDREN_NAME','$CHILDREN_DATEOFBIRTH', '$PARENTID')";
        ...
        $succesMessage = "chldren created successfully";
    ...
    <div class="container my-5">
        ...
        <form action="" method="post">
            ...
            <div class="row md-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="CHILDREN_DATEOFBIRTH" value="<?php echo $CHILDREN_DATEOFBIRTH; ?>">
                </div>
            </div>
